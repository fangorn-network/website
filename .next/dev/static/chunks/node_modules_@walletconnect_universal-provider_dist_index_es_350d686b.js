...
;
;
const Ca = "error", Hg = "wss://relay.walletconnect.com", $g = "wc", Ug = "universal_provider", Ia = `${$g}@2:${Ug}:`, Wg = "https://rpc.walletconnect.com/v1", ot = {
    DEFAULT_CHAIN_CHANGED: "default_chain_changed"
};
var pe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : ("TURBOPACK compile-time value", "object") < "u" ? /*TURBOPACK member replacement*/ __turbopack_context__.g : typeof self < "u" ? self : {}, $i = {
    exports: {}
}; /**
 * @license
...
(function(C, u) {
    (function() {
        var i, p = "4.17.21", I = 200, D = "Unsupported core-js use. Try https://npms.io/search?q=ponyfill.", F = "Expected a function", Fn = "Invalid `variable` option passed into `_.template`", Gt = "__lodash_hash_undefined__", lr = 500, At = "__lodash_placeholder__", Ln = 1, Mn = 2, Ct = 4, It = 1, de = 2, vn = 1, ft = 2, Mi = 4, Dn = 8, xt = 16, Nn = 32, Et = 64, qn = 128, zt = 256, pr = 512, Ta = 30, La = "...", Da = 800, Na = 16, qi = 1, Ha = 2, $a = 3, ct = 1 / 0, kn = 9007199254740991, Ua = 17976931348623157e292, ge = 0 / 0, Hn = 4294967295, Wa = Hn - 1, Fa = Hn >>> 1, Ma = [
            ...
            Or,
            So
        ].join("|") + ")", $o = RegExp(Er, "g"), Uo = RegExp(Ce, "g"), Rr = RegExp(yr + "(?=" + yr + ")|" + Ho + hs, "g"), Wo = RegExp([
            Ot + "?" + es + "+" + as + "(?=" + [
                ns,
                Ot,
                "$"
            ...
            ts,
            No
        ].join("|"), "g"), Fo = RegExp("[" + ss + Ae + Ji + ki + "]"), Mo = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, qo = [
            "Array",
            "Buffer",
            "DataView",
            "Date",
        ...
        var Go = {
            ...
            "\u2028": "u2028",
            "\u2029": "u2029"
        }, Zo = parseFloat, Jo = parseInt, ls = typeof pe == "object" && pe && pe.Object === Object && pe, Xo = typeof self == "object" && self && self.Object === Object && self, k = ls || Xo || Function("return this")(), br = u && !u.nodeType && u, ht = br && !0 && C && !C.nodeType && C, ps = ht && ht.exports === br, Tr = ps && ls.process, _n = function() {
            try {
        ...
        var Pf = function h(g) {
            ...
            var d = g.Array, P = g.Date, S = g.Error, $ = g.Function, X = g.Math, M = g.Object, qr = g.RegExp, Af = g.String, wn = g.TypeError, ye = d.prototype, Cf = $.prototype, Dt = M.prototype, Se = g["__core-js_shared__"], Oe = Cf.toString, W = Dt.hasOwnProperty, If = 0, bs = function() {
            ...
            }(), Sf = g.clearTimeout !== k.clearTimeout && g.clearTimeout, Of = P && P.now !== k.Date.now && P.now, Rf = g.setTimeout !== k.setTimeout && g.setTimeout, He = X.ceil, $e = X.floor, Br = M.getOwnPropertySymbols, bf = be ? be.isBuffer : i, Hs = g.isFinite, Tf = ye.join, Lf = Os(M.keys, M), Q = X.max, nn = X.min, Df = P.now, Nf = g.parseInt, $s = X.random, Hf = ye.reverse, Gr = _t(g, "DataView"), ne = _t(g, "Map"), zr = _t(g, "Promise"), Nt = _t(g, "Set"), te = _t(g, "WeakMap"), ee = _t(M, "create"), Ue = te && new te, Ht = {}, $f = mt(Gr), Uf = mt(ne), Wf = mt(zr), Ff = mt(Nt), Mf = mt(te), We = et ? et.prototype : i, re = We ? We.valueOf : i, Us = We ? We.toString : i;
            function a(n) {
            ...
            function Gf() {
                var n = this.__wrapped__.value(), t = this.__dir__, e = O(n), r = t < 0, s = e ? n.length : 0, o = th(0, s, this.__views__), f = o.start, c = o.end, l = c - f, v = r ? c : f - 1, _ = this.__iteratees__, m = _.length, w = 0, A = nn(l, this.__takeCount__);
                if (!e || !r && s == l && A == l) return au(n, this.__actions__);
                var E = [];
                n: for(; l-- && w < A;){
                    v += t;
                    for(var b = -1, y = n[v]; ++b < m;){
                        var L = _[b], H = L.iteratee, dn = L.type, sn = H(y);
                        if (dn == Ha) y = sn;
                        else if (!sn) {
                            if (dn == qi) continue n;
                            break n;
            ...
            function hc(n, t) {
                ...
                if (e instanceof Gn) {
                    var r = e.__data__;
                    if (!ne || r.length < I - 1) return r.push([
                        n,
                        t
            ...
            function Ws(n, t) {
                var e = O(n), r = !e && wt(n), s = !e && !r && at(n), o = !e && !r && !s && Mt(n), f = e || r || s || o, c = f ? Wr(n.length, Af) : [], l = c.length;
            ...
            function An(n, t, e, r, s, o) {
                ...
                var E = v ? l ? li : hi : l ? on : V, b = _ ? i : E(n);
            ...
            function se(n, t, e, r) {
                var s = -1, o = Ie, f = !0, c = n.length, l = [], v = t.length;
                if (!c) return l;
            ...
            function Ec(n, t, e, r, s, o) {
                var f = O(n), c = O(t), l = f ? ve : tn(n), v = c ? ve : tn(t);
                l = l == yt ? Bn : l, v = v == yt ? Bn : v;
                var _ = l == Bn, m = v == Bn, w = l == v;
                if (w && at(n)) {
                    if (!at(t)) return !1;
                    f = !0, _ = !1;
                }
                ...
                if (!(e & It)) {
                    var A = _ && W.call(n, "__wrapped__"), E = m && W.call(t, "__wrapped__");
                    if (A || E) {
                        var b = A ? n.value() : n, y = E ? t.value() : t;
            ...
            function Ge(n, t, e, r, s) {
                n !== t && Zr(t, function(o, f) {
                    if (s || (s = new Rn), z(o)) Tc(n, t, f, e, Ge, r, s);
                    else {
            ...
            function ni(n, t, e, r) {
                var s = r ? ef : Rt, o = -1, f = t.length, c = n;
            ...
            function ri(n, t, e, r) {
                ...
                for(var f = t !== t, c = t === null, l = pn(t), v = t === i; s < o;){
                    var _ = $e((s + o) / 2), m = e(n[_]), w = m !== i, A = m === null, E = m === m, b = pn(m);
                    if (f) var y = r || E;
                    else v ? y = E && (r || w) : c ? y = E && w && (r || !A) : l ? y = E && w && !A && (r || !b) : A || b ? y = !1 : y = r ? m <= t : m < t;
                    y ? s = _ + 1 : o = _;
                }
                return nn(o, Wa);
            }
            ...
            function it(n, t, e) {
                var r = -1, s = Ie, o = n.length, f = !0, c = [], l = c;
                if (e) f = !1, s = Lr;
                else if (o >= I) {
                    var v = t ? null : Qc(n);
                    if (v) return Ee(v);
            ...
            function _u(n) {
                return function(t) {
                    t = U(t);
                    var e = bt(t) ? On(t) : i, r = e ? e[0] : t.charAt(0), s = e ? ut(e, 1).join("") : t.slice(1);
                    return r[n]() + s;
                };
            }
            function Wt(n) {
            ...
            function Cu(n, t, e, r, s, o, f, c, l, v) {
                var _ = t & Dn, m = _ ? f : i, w = _ ? i : f, A = _ ? o : i, E = _ ? i : o;
            ...
            function ci(n) {
                ...
                return function(e, r) {
                    if (e = xn(e), r = r == null ? 0 : nn(R(r), 292), r && Hs(e)) {
                        var s = (U(e) + "e").split("e"), o = t(s[0] + "e" + (+s[1] + r));
                        return s = (U(o) + "e").split("e"), +(s[0] + "e" + (+s[1] - r));
                    }
                    return t(e);
                };
            }
            var Qc = Nt && 1 / Ee(new Nt([
                ,
                -0
            ]))[1] == ct ? function(n) {
                return new Nt(n);
            ...
            function Yn(n, t, e, r, s, o, f, c) {
                ...
                if (w && hh(A, w), n = A[0], t = A[1], e = A[2], r = A[3], s = A[4], c = A[9] = A[9] === i ? l ? 0 : n.length : Q(A[9] - v, 0), !c && t & (Dn | xt) && (t &= ~(Dn | xt)), !t || t == vn) var E = Zc(n, t, e);
                else t == Dn || t == xt ? E = Jc(n, t, c) : (t == Nn || t == (vn | Nn)) && !s.length ? E = Xc(n, t, e, r) : E = Ze.apply(i, A);
                var b = w ? ru : Nu;
                return Hu(b(E, A), n, t);
            }
            function xu(n, t, e, r) {
            ...
            function yu(n, t, e, r, s, o) {
                var f = e & It, c = n.length, l = t.length;
            ...
            function jc(n, t, e, r, s, o) {
                var f = e & It, c = hi(n), l = c.length, v = hi(t), _ = v.length;
                if (l != _ && !f) return !1;
                for(var m = l; m--;){
                    var w = c[m];
                    if (!(f ? w in t : W.call(t, w))) return !1;
                }
                var A = o.get(n), E = o.get(t);
...
`);
            ...
            function hh(n, t) {
                var e = n[1], r = t[1], s = e | r, o = s < (vn | ft | qn), f = r == qn && e == Dn || r == qn && e == zt && n[7].length <= t[8] || r == (qn | zt) && t[7].length <= t[8] && e == Dn;
                if (!(o || f)) return n;
            ...
            function ql(n, t, e) {
                var r = O(n) ? ko : xs, s = arguments.length < 3;
            ...
            var Vp = Pu(function(n, t, e) {
                ...
                t != null && typeof t.toString != "function" && (t = Re.call(t)), W.call(n, t) ? n[t].push(e) : n[t] = [
                    e
                ];
            }, x), jp = T(ue);
            function V(n) {
            ...
            function Nd(n, t, e) {
                ...
                var s = ar({}, t.imports, r.imports, xu), o = V(s), f = Fr(s, o), c, l, v = 0, _ = t.interpolate || Pe, m = "__p += '", w = qr((t.escape || Pe).source + "|" + _.source + "|" + (_ === Yi ? ho : Pe).source + "|" + (t.evaluate || Pe).source + "|$", "g"), A = "//# sourceURL=" + (W.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Bo + "]") + `
`;
...
`) + m + `return __p
            ...
            function Ud(n, t, e) {
                ...
                var r = On(n), s = On(t), o = ys(r, s), f = Ss(r, s) + 1;
            ...
            function Ti(n, t, e) {
                ...
                var o = !(z(e) && "chain" in e) || !!e.chain, f = Xn(n);
            ...
            return a.after = Xl, a.ary = Ju, a.assign = $p, a.assignIn = oa, a.assignInWith = ar, a.assignWith = Up, a.at = Wp, a.before = Xu, a.bind = Ci, a.bindAll = Gd, a.bindKey = Qu, a.castArray = ap, a.chain = Ku, a.chunk = vh, a.compact = _h, a.concat = mh, a.cond = zd, a.conforms = Kd, a.constant = Ri, a.countBy = yl, a.create = Fp, a.curry = Vu, a.curryRight = ku, a.debounce = ju, a.defaults = Mp, a.defaultsDeep = qp, a.defer = Ql, a.delay = Vl, a.difference = wh, a.differenceBy = Ph, a.differenceWith = Ah, a.drop = Ch, a.dropRight = Ih, a.dropRightWhile = xh, a.dropWhile = Eh, a.fill = yh, a.filter = Ol, a.flatMap = Tl, a.flatMapDeep = Ll, a.flatMapDepth = Dl, a.flatten = qu, a.flattenDeep = Sh, a.flattenDepth = Oh, a.flip = kl, a.flow = Zd, a.flowRight = Jd, a.fromPairs = Rh, a.functions = Jp, a.functionsIn = Xp, a.groupBy = Nl, a.initial = Th, a.intersection = Lh, a.intersectionBy = Dh, a.intersectionWith = Nh, a.invert = Vp, a.invertBy = kp, a.invokeMap = $l, a.iteratee = bi, a.keyBy = Ul, a.keys = V, a.keysIn = on, a.map = tr, a.mapKeys = nd, a.mapValues = td, a.matches = Xd, a.matchesProperty = Qd, a.memoize = rr, a.merge = ed, a.mergeWith = fa, a.method = Vd, a.methodOf = kd, a.mixin = Ti, a.negate = ir, a.nthArg = ng, a.omit = rd, a.omitBy = id, a.once = jl, a.orderBy = Wl, a.over = tg, a.overArgs = np, a.overEvery = eg, a.overSome = rg, a.partial = Ii, a.partialRight = na, a.partition = Fl, a.pick = sd, a.pickBy = ca, a.property = _a, a.propertyOf = ig, a.pull = Wh, a.pullAll = Gu, a.pullAllBy = Fh, a.pullAllWith = Mh, a.pullAt = qh, a.range = sg, a.rangeRight = ug, a.rearg = tp, a.reject = Bl, a.remove = Bh, a.rest = ep, a.reverse = Pi, a.sampleSize = zl, a.set = ad, a.setWith = od, a.shuffle = Kl, a.slice = Gh, a.sortBy = Jl, a.sortedUniq = Qh, a.sortedUniqBy = Vh, a.split = Td, a.spread = rp, a.tail = kh, a.take = jh, a.takeRight = nl, a.takeRightWhile = tl, a.takeWhile = el, a.tap = _l, a.throttle = ip, a.thru = nr, a.toArray = sa, a.toPairs = ha, a.toPairsIn = la, a.toPath = hg, a.toPlainObject = aa, a.transform = fd, a.unary = sp, a.union = rl, a.unionBy = il, a.unionWith = sl, a.uniq = ul, a.uniqBy = al, a.uniqWith = ol, a.unset = cd, a.unzip = Ai, a.unzipWith = zu, a.update = hd, a.updateWith = ld, a.values = qt, a.valuesIn = pd, a.without = fl, a.words = ga, a.wrap = up, a.xor = cl, a.xorBy = hl, a.xorWith = ll, a.zip = pl, a.zipObject = dl, a.zipObjectDeep = gl, a.zipWith = vl, a.entries = ha, a.entriesIn = la, a.extend = oa, a.extendWith = ar, Ti(a, a), a.add = pg, a.attempt = va, a.camelCase = _d, a.capitalize = pa, a.ceil = dg, a.clamp = dd, a.clone = op, a.cloneDeep = cp, a.cloneDeepWith = hp, a.cloneWith = fp, a.conformsTo = lp, a.deburr = da, a.defaultTo = Yd, a.divide = gg, a.endsWith = md, a.eq = bn, a.escape = wd, a.escapeRegExp = Pd, a.every = Sl, a.find = Rl, a.findIndex = Fu, a.findKey = Bp, a.findLast = bl, a.findLastIndex = Mu, a.findLastKey = Gp, a.floor = vg, a.forEach = Yu, a.forEachRight = Zu, a.forIn = zp, a.forInRight = Kp, a.forOwn = Yp, a.forOwnRight = Zp, a.get = yi, a.gt = pp, a.gte = dp, a.has = Qp, a.hasIn = Si, a.head = Bu, a.identity = fn, a.includes = Hl, a.indexOf = bh, a.inRange = gd, a.invoke = jp, a.isArguments = wt, a.isArray = O, a.isArrayBuffer = gp, a.isArrayLike = an, a.isArrayLikeObject = Y, a.isBoolean = vp, a.isBuffer = at, a.isDate = _p, a.isElement = mp, a.isEmpty = wp, a.isEqual = Pp, a.isEqualWith = Ap, a.isError = xi, a.isFinite = Cp, a.isFunction = Xn, a.isInteger = ta, a.isLength = sr, a.isMap = ea, a.isMatch = Ip, a.isMatchWith = xp, a.isNaN = Ep, a.isNative = yp, a.isNil = Op, a.isNull = Sp, a.isNumber = ra, a.isObject = z, a.isObjectLike = K, a.isPlainObject = le, a.isRegExp = Ei, a.isSafeInteger = Rp, a.isSet = ia, a.isString = ur, a.isSymbol = pn, a.isTypedArray = Mt, a.isUndefined = bp, a.isWeakMap = Tp, a.isWeakSet = Lp, a.join = Hh, a.kebabCase = Ad, a.last = In, a.lastIndexOf = $h, a.lowerCase = Cd, a.lowerFirst = Id, a.lt = Dp, a.lte = Np, a.max = _g, a.maxBy = mg, a.mean = wg, a.meanBy = Pg, a.min = Ag, a.minBy = Cg, a.stubArray = Di, a.stubFalse = Ni, a.stubObject = ag, a.stubString = og, a.stubTrue = fg, a.multiply = Ig, a.nth = Uh, a.noConflict = jd, a.noop = Li, a.now = er, a.pad = xd, a.padEnd = Ed, a.padStart = yd, a.parseInt = Sd, a.random = vd, a.reduce = Ml, a.reduceRight = ql, a.repeat = Od, a.replace = Rd, a.result = ud, a.round = xg, a.runInContext = h, a.sample = Gl, a.size = Yl, a.snakeCase = bd, a.some = Zl, a.sortedIndex = zh, a.sortedIndexBy = Kh, a.sortedIndexOf = Yh, a.sortedLastIndex = Zh, a.sortedLastIndexBy = Jh, a.sortedLastIndexOf = Xh, a.startCase = Ld, a.startsWith = Dd, a.subtract = Eg, a.sum = yg, a.sumBy = Sg, a.template = Nd, a.times = cg, a.toFinite = Qn, a.toInteger = R, a.toLength = ua, a.toLower = Hd, a.toNumber = xn, a.toSafeInteger = Hp, a.toString = U, a.toUpper = $d, a.trim = Ud, a.trimEnd = Wd, a.trimStart = Fd, a.truncate = Md, a.unescape = qd, a.uniqueId = lg, a.upperCase = Bd, a.upperFirst = Oi, a.each = Yu, a.eachRight = Zu, a.first = Bu, Ti(a, function() {
                ...
                s && (a.prototype[t] = function() {
                    var f = this.__wrapped__, c = r ? [
                        1
                    ] : arguments, l = f instanceof N, v = c[0], _ = l || O(f), m = function(L) {
                        var H = s.apply(a, nt([
                            L
                        ], c));
                        return r && w ? H[0] : H;
                    ...
                    var w = this.__chain__, A = !!this.__actions__.length, E = o && !w, b = l && !A;
                    if (!o && _) {
                        f = b ? f : new N(this);
                        var y = n.apply(f, c);
...
var Fg = Object.defineProperty, Mg = Object.defineProperties, qg = Object.getOwnPropertyDescriptors, xa = Object.getOwnPropertySymbols, Bg = Object.prototype.hasOwnProperty, Gg = Object.prototype.propertyIsEnumerable, Ea = (C, u, i)=>u in C ? Fg(C, u, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: i
...
function Sa(C) {
    var u, i, p, I;
    const D = {};
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidObject"])(C)) return D;
    for (const [F, Fn] of Object.entries(C)){
        const Gt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCaipNamespace"])(F) ? [
            F
        ] : Fn.chains, lr = Fn.methods || [], At = Fn.events || [], Ln = Fn.rpcMap || {}, Mn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(F);
        D[Mn] = zg(fr(fr({}, D[Mn]), Fn), {
            chains: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeArrays"])(Gt, (u = D[Mn]) == null ? void 0 : u.chains),
            methods: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeArrays"])(lr, (i = D[Mn]) == null ? void 0 : i.methods),
            events: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeArrays"])(At, (p = D[Mn]) == null ? void 0 : p.events),
...
function Jg(C) {
    ...
    for (const [i, p] of Object.entries(C)){
        const I = p.methods || [], D = p.events || [], F = p.accounts || [], Fn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCaipNamespace"])(i) ? [
            i
        ] : p.chains ? p.chains : ya(p.accounts);
        u[i] = {
            chains: Fn,
            methods: I,
            events: D,
...
class Qg {
    ...
    createHttpProvider(u, i) {
        ...
        return typeof p > "u" ? void 0 : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$universal$2d$provider$2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$provider$2f$dist$2f$esm$2f$provider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JsonRpcProvider"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$http$2d$connection$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HttpConnection"](p, J("disableProviderPing")));
    }
    setHttpProvider(u, i) {
        const p = this.createHttpProvider(u, i);
        p && (this.httpProviders[u] = p);
    ...
    async handleSwitchChain(u) {
        ...
        if (this.isChainApproved(D)) this.setDefaultChain(`${D}`);
        ...
        }), this.setDefaultChain(`${D}`);
        else throw new Error(`Failed to switch to chain 'eip155:${D}'. The chain is not approved or the wallet does not support 'wallet_switchEthereumChain' method.`);
        return null;
    }
    isChainApproved(u) {
...
var ev = Object.defineProperty, rv = Object.defineProperties, iv = Object.getOwnPropertyDescriptors, Ra = Object.getOwnPropertySymbols, sv = Object.prototype.hasOwnProperty, uv = Object.prototype.propertyIsEnumerable, ba = (C, u, i)=>u in C ? ev(C, u, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: i
...
class hr {
    constructor(u){
        this.events = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$events$2f$events$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], this.rpcProviders = {}, this.shouldAbortPairingAttempt = !1, this.maxPairingAttempts = 10, this.disableProviderPing = !1, this.providerOpts = u, this.logger = typeof u?.logger < "u" && typeof u?.logger != "string" ? u.logger : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$logger$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pino"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$logger$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultLoggerOptions"])({
            level: u?.logger || Ca
    ...
    async pair(u) {
        ...
        do {
            ...
            const { uri: p, approval: I } = await this.client.connect({
                pairingTopic: u,
            ...
            p && (this.uri = p, this.events.emit("display_uri", p)), await I().then((D)=>{
                ...
                if (D.message !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$sign$2d$client$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROPOSAL_EXPIRY_MESSAGE"]) throw D;
                i++;
            });
        }while (!this.session)
    ...
    createProviders() {
        ...
        Wi("client", this.client), Wi("events", this.events), Wi("disableProviderPing", this.disableProviderPing), u.forEach((i)=>{
            if (!this.session) return;
            const p = Kg(i, this.session), I = ya(p), D = Yg(this.namespaces, this.optionalNamespaces), F = Fi(cr({}, D[i]), {
                accounts: p,
                chains: I
            });
            switch(i){
    ...
    registerEventListeners() {
        ...
        this.client.on("session_ping", (u)=>{
            ...
            if (p.name === "accountsChanged") {
                const I = p.data;
                I && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidArray"])(I) && this.events.emit("accountsChanged", I.map(Zg));
            ...
            var p;
            const { namespaces: I } = i, D = (p = this.client) == null ? void 0 : p.session.get(u);
            ...
            await this.cleanup(), this.events.emit("session_delete", u), this.events.emit("disconnect", Fi(cr({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSdkError"])("USER_DISCONNECTED")), {
                data: u.topic
            }));
    ...
    setNamespaces(u) {
        const { namespaces: i, optionalNamespaces: p, sessionProperties: I } = u;
    ...
    validateChain(u) {
        ...
        if (i && !Object.keys(this.namespaces || {}).map((F)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(F)).includes(i)) throw new Error(`Namespace '${i}' is not configured. Please call connect() first with namespace config.`);
        if (i && p) return [
            i,
            p
        ];
        const I = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(Object.keys(this.namespaces)[0]), D = this.rpcProviders[I].getDefaultChain();
        return [
            I,
            D
        ];
...
//# sourceMappingURL=node_modules_%40walletconnect_universal-provider_dist_index_es_350d686b.js.map