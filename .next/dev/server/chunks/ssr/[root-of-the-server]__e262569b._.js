...
// import { encryptString, AccessControlCondition } from "@lit-protocol/lit-node-client/utility-functions";
__turbopack_context__.s([
    "default",
...
class Lit {
   ...
   */ async encrypt(message, condition) {
        ...
        const { ciphertext, dataToEncryptHash } = await LitJsSdk.encryptString({
            // Ensure accessControlConditions is defined and in scope
            condition,
...
function Page() {
    ...
    const handleUpload = async (file, config)=>{
        ...
        // encrypt the file for an erc-2981 token
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e262569b._.js.map